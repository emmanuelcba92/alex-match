...
import { Calculator, Divide, BookOpen, Triangle, Percent, Coins, Hash } from 'lucide-react';
...
const TopicSelector = ({ currentTopic, onSelectTopic, config, onUpdateConfig }) => {
    const topics = [
        ...
        { id: TOPICS.DECIMALS, label: 'Decimales', icon: Coins },
        { id: TOPICS.COMBINED, label: 'Cálculos Combinados', icon: Hash },
